landing_editor.registerBlock('service_cards_block', function ($, $el, data) {
	...
	this.afterRender = function () {
		...
		$res.html(
			landing_editor.renderTemplate('service_cards_block-items', data)
		);
		...
		$el.on('click', '.sp-lists-add', function () {
			$res.append(
				landing_editor.renderTemplate('service_cards_block-items', {
					elements: [
						{
							title: '',
							subtitle: '',
